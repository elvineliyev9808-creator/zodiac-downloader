...
<head>
    ...
    <style>
        ...
        body { 
            ...
            margin: 0; overflow-x: hidden; display: flex; align-items: center; justify-content: center; min-height: 100vh;
        }
    ...
    <div class="container">
        ...
        <div class="box tt-box">
            ...
            <form method="POST">
                ...
                <button type="submit" class="tt-btn">ANALİZ ET</button>
            </form>
        ...
        <div class="box ig-box">
            ...
            <form method="POST">
                ...
                <button type="submit" class="ig-btn">ANALİZ ET</button>
            </form>
        ...
        <div class="footer">
            ...
            <a href="https://t.me/BakuUnderground">@KANAL</a>
        </div>
    </div>
